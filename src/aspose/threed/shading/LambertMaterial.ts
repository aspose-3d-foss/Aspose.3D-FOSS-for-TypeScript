...
export class LambertMaterial extends Material {
    ...
    private _ambientColor: Vector3 | null = null;
    private _diffuseColor: Vector3 | null = null;
    private _transparentColor: Vector3 | null = null;
    ...
    get ambientColor(): Vector3 | null {
        return this._ambientColor;
    }

    set ambientColor(value: Vector3 | null) {
        this._ambientColor = value;
    }

    get diffuseColor(): Vector3 | null {
        return this._diffuseColor;
    }

    set diffuseColor(value: Vector3 | null) {
        this._diffuseColor = value;
    }

    get transparentColor(): Vector3 | null {
        return this._transparentColor;
    }

    set transparentColor(value: Vector3 | null) {
